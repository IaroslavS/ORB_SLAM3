...
protected:
    ...
    void static optimize_EKF_with_barometer(Frame* current_frame, const float& barometer_cov, const float& init_altitude, Frame* prev_frame);
    ...
    float relative_gain_along_z_wrt_altitude_;
